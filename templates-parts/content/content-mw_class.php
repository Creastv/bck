...
$ticket = get_field('kup_bilet', $post->ID);
$link = get_field('link');
if( $link ): 
    $link_url = $link['url'];
...
<article class="card-event <?php echo $post->ID; ?>">
    <div class="img" >
        <?php if (has_post_thumbnail( $post->ID ) ): ?>
            <?php the_post_thumbnail('post-futured', array( 'alt' => get_the_title(), 'title' => get_the_title() )); ?>
        <?php else: ?>
            <img src="<?php echo get_template_directory_uri(); ?>/src/img/thumbnail.png" alt="<?php the_title(); ?>" title="<?php the_title(); ?>">
        <?php endif; ?>
